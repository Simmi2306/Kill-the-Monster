...
function draw() {
  ...
  textSize(30);
  fill("Black");
  text("Kill The Monster",55,55);
  textSize(20);
  text("Saving Our Plant Earth from Monster by killing him",55,82);
  text("by A Superhero - Captain Marval",215,110);
  textSize(25);
  text("Drag the Superhero to Kill the Monster",40,660);
  textSize(15);
  text("Today's Mission -",55,25)
